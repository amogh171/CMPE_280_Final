...
module.exports.stateInfo = function(request, result) 
{
    ...
    stateInfo.find({abbrev: request.params.id}, function(err, results){
        ...
        race_age = {
            "CA" : {"White":  [  0, 0.2, 0.26, 0.33, 0.05, 0.21, 0.1, 0.06, 0.01, 0],
                    "Black" : [0, 0.067, 0.233, 0.167, 0.2, 0.133, 0.1, 0.06, 0.01, 0],
                    "Hispanic" : [ 0, 0.1, 0.2, 0.15, 0.12, 0.25, 0.05,0.06, 0.01, 0]},
    
            "KY" : {"White":  [0.0, 0.10, 0.19, 0.26, 0.29, 0.14, 0.1, 0.06, 0.01, 0],
                    "Black" : [0.0, 0.10, 0.28, 0.33, 0.05, 0.09, 0.08,0.06, 0.01, 0],
                    "Hispanic" : [0.0, 0.14, 0.04, 0.35, 0.33, 0.13, 0.05, 0.06, 0.01, 0]},
    
            "WV" : {"White":  [0.0, 0.18, 0.1, 0.19, 0.27, 0.13, 0.2, 0.06, 0.01, 0],
                    "Black" : [0.0, 0.14, 0.26, 0.21, 0.04, 0.2, 0.17, 0.06, 0.01, 0],
            ...
            "AZ" : {"White": [0.0, 0.14, 0.25, 0.24, 0.23, 0.13, 0.11, 0.06, 0.01, 0],
                    ...
                    "Hispanic" : [ 0, 0.11, 0.1, 0.25, 0.2, 0.15, 0.15, 0.06, 0.01, 0]},
